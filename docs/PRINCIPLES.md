...
- [Overview](./00-overview.md) · [Bible editor product vision](./15-bible-editor-product-vision.md) · [Translation helps](./17-translation-helps-and-resources.md) · [Translation helps domain API](./18-translation-helps-domain-api.md) · [Package map](./02-package-map.md) · [Hexagonal apps](./05-hexagonal-apps.md) · [UI philosophy](./04-ui-philosophy.md) · [Milestones & scope](./13-milestones-and-scope.md) · [AGENTS.md](../AGENTS.md)
