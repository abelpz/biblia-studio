...
| [Translation helps & resources](./17-translation-helps-and-resources.md) | Glossary and product intent for Translation Helps, GL→GL, **source-first** pairing; links upstream specs                                     |
| [Translation helps domain API](./18-translation-helps-domain-api.md)     | **TypeScript library API:** `door43` + `translation` signatures & types; also browse **`/docs/translation-helps-api`** in `apps/web` locally |
