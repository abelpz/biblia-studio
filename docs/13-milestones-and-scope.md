...
| **M4 — Translation helps in web**                         | Closed | [PR #19](https://github.com/abelpz/biblia-studio/pull/19) — issue [#18](https://github.com/abelpz/biblia-studio/issues/18); **`/translation-helps`** (tc-ready list + optional GL→GL compare).                                                                                                                                   |
...
| **Apps/web**    | Door43 repo list (M1), `/editor` (M2), **`/translation-helps`** ([PR #19](https://github.com/abelpz/biblia-studio/pull/19) / [#18](https://github.com/abelpz/biblia-studio/issues/18))                                                                                 | Source-first drill-down, book × help matrix UI                                           |
...
_None — pick the next outcome (e.g. source-first UI, book × help matrix) in a new GitHub issue / milestone._
