...
| **Apps/web**    | Door43 repo list (M1), `/editor` (M2), **`/translation-helps`** ([PR #19](https://github.com/abelpz/biblia-studio/pull/19) / [#18](https://github.com/abelpz/biblia-studio/issues/18); source-first [PR #22](https://github.com/abelpz/biblia-studio/pull/22) / [#21](https://github.com/abelpz/biblia-studio/issues/21); Door43 repo + metadata [PR #25](https://github.com/abelpz/biblia-studio/pull/25) / [#24](https://github.com/abelpz/biblia-studio/issues/24); optional catalog **bundle** (zip) [#26](https://github.com/abelpz/biblia-studio/issues/26)) | Book × help matrix UI, tag vs default-branch parity                                      |
...
_None — pick the next outcome (e.g. book × help matrix, tag vs default-branch parity) in a new GitHub issue / milestone._
